...
public class PromjeneAdmin extends Entitet{
    ...
    public PromjeneAdmin(Integer id, String staraVrijednost, String novaVrijednost, String adminIme, Timestamp datum_i_vrijeme) {
        super(id);
        this.id = id;
